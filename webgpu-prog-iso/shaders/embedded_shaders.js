...
fn main_1() {
  ...
  loop {
    ...
    loop {
      ...
      if (x_683) {
        let x_690 : u32 = ray_index;
        let x_692 : u32 = x_371.ray_offsets[x_690];
        let x_694 : u32 = x_347.speculation_count;
        let x_696 : u32 = speculated;
        let x_698 : u32 = block_index;
        x_689.block_ids[((x_692 * x_694) + x_696)] = x_698;
        let x_700 : u32 = speculated;
        speculated = (x_700 + bitcast<u32>(1i));
        let x_702 : u32 = speculated;
        let x_704 : u32 = x_347.speculation_count;
        if ((x_702 == x_704)) {
          let x_708 : u32 = ray_index;
          let x_711 : GridIterator = coarse_grid_iter;
          param_24 = x_711;
          let x_712 : i32 = grid_iterator_get_cell_id_struct_GridIterator_vi3_vi3_vf3_vi3_vf3_f11_(&(param_24));
          x_479.iterator_state[(x_708 * 2u)].cell_id = x_712;
          let x_715 : u32 = ray_index;
          let x_718 : vec3<f32> = coarse_grid_iter.t_max;
          x_479.iterator_state[(x_715 * 2u)].t_max = x_718;
          let x_720 : u32 = ray_index;
          let x_724 : GridIterator = grid_iter_2;
          param_25 = x_724;
          let x_725 : i32 = grid_iterator_get_cell_id_struct_GridIterator_vi3_vi3_vf3_vi3_vf3_f11_(&(param_25));
          x_479.iterator_state[((x_720 * 2u) + 1u)].cell_id = x_725;
          let x_727 : u32 = ray_index;
          let x_731 : vec3<f32> = grid_iter_2.t_max;
          x_479.iterator_state[((x_727 * 2u) + 1u)].t_max = x_731;
          return;
        }
      }
      let x_735 : GridIterator = grid_iter_2;
      param_26 = x_735;
      grid_iterator_advance_struct_GridIterator_vi3_vi3_vf3_vi3_vf3_f11_(&(param_26));
      let x_737 : GridIterator = param_26;
      grid_iter_2 = x_737;
    }
    first_coarse_iter = false;
    let x_739 : GridIterator = coarse_grid_iter;
    param_27 = x_739;
    grid_iterator_advance_struct_GridIterator_vi3_vi3_vf3_vi3_vf3_f11_(&(param_27));
    let x_741 : GridIterator = param_27;
    coarse_grid_iter = x_741;
  }
  let x_742 : u32 = speculated;
  if ((x_742 == 0u)) {
    let x_746 : u32 = ray_index;
    x_334.rays[x_746].t = 340282346638528859811704183484516925440.0f;
  } else {
    let x_749 : u32 = speculated;
    let x_751 : u32 = x_347.speculation_count;
    if ((x_749 < x_751)) {
      let x_755 : u32 = ray_index;
...
@group(1) @binding(3) var<storage, read_write> x_1602 : BlockInformation;

var<private> gl_WorkGroupID : vec3<u32>;

@group(2) @binding(0) var<uniform> x_1608 : BlockIDOffset;

@group(1) @binding(0) var<uniform> x_1668 : ViewParams;

@group(1) @binding(2) var<storage, read_write> x_1734 : RayIDs;

@group(1) @binding(5) var<storage, read_write> x_1749 : SpeculativeIDs;

@group(1) @binding(1) var<storage, read_write> x_1761 : RayInformation;

@group(1) @binding(6) var<storage, read_write> x_1916 : RayRGBZ;
...
fn marmitt_intersect_vf3_vf3_vf3_f1_8__f1_f1_f1_(vol_eye : vec3<f32>, grid_ray_dir : vec3<f32>, v000_2 : vec3<f32>, vertex_values_1 : array<f32, 8u>, t_prev : f32, t_next : f32, t_hit : ptr<function, f32>) -> bool {
  ...
  if (!((sign(x_1517) == sign(x_1519)))) {
    ...
    loop {
      ...
      let x_1533 : f32 = t_in;
      let x_1534 : f32 = t_out;
      let x_1535 : f32 = t_in;
      let x_1537 : f32 = f_in;
      let x_1540 : f32 = f_out;
      let x_1541 : f32 = f_in;
      t_2 = (x_1533 + (((x_1534 - x_1535) * -(x_1537)) / (x_1540 - x_1541)));
      let x_1546 : vec4<f32> = poly_3;
      let x_1547 : f32 = t_2;
      let x_1548 : f32 = evaluate_polynomial_vf4_f1_(x_1546, x_1547);
      f_t = x_1548;
      let x_1549 : f32 = f_t;
      let x_1551 : f32 = f_in;
      if ((sign(x_1549) == sign(x_1551))) {
        let x_1556 : f32 = t_2;
        t_in = x_1556;
        let x_1557 : f32 = f_t;
        f_in = x_1557;
    ...
    let x_1564 : f32 = t_in;
    let x_1565 : f32 = t_out;
    let x_1566 : f32 = t_in;
    let x_1568 : f32 = f_in;
    let x_1571 : f32 = f_out;
    let x_1572 : f32 = f_in;
    cell_t_hit = (x_1564 + (((x_1565 - x_1566) * -(x_1568)) / (x_1571 - x_1572)));
    let x_1577 : vec3<f32> = cell_p;
    let x_1578 : vec3<f32> = cell_ray_dir;
    let x_1579 : f32 = cell_t_hit;
    hit_p_1 = (x_1577 + (x_1578 * x_1579));
    let x_1582 : vec3<f32> = hit_p_1;
    *(t_hit) = (length((x_1582 - vol_eye)) / length(grid_ray_dir));
    return true;
  }
  return false;
}
...
fn shading_vf3_vf3_vf3_vf3_(N : ptr<function, vec3<f32>>, V : ptr<function, vec3<f32>>, L : ptr<function, vec3<f32>>, base_color : ptr<function, vec3<f32>>) -> vec3<f32> {
  ...
  c_1 = (x_1257 * 0.20000000298023223877f);
  let x_1261 : vec3<f32> = *(L);
  let x_1262 : vec3<f32> = *(N);
  let x_1266 : vec3<f32> = *(base_color);
  let x_1268 : vec3<f32> = c_1;
  c_1 = (x_1268 + (x_1266 * (0.60000002384185791016f * clamp(dot(x_1261, x_1262), 0.0f, 1.0f))));
  let x_1271 : vec3<f32> = H;
  let x_1272 : vec3<f32> = *(N);
  let x_1277 : f32 = (0.10000000149011611938f * pow(clamp(dot(x_1271, x_1272), 0.0f, 1.0f), 5.0f));
...
fn main_1() {
  ...
  let x_1591 : u32 = gl_LocalInvocationID.x;
  if ((x_1591 == 0u)) {
    let x_1605 : u32 = gl_WorkGroupID.x;
    let x_1610 : u32 = x_1608.id_offset;
    let x_1614 : BlockInfo_1 = x_1602.blocks[(x_1605 + x_1610)];
    block_info.id = x_1614.id;
    block_info.ray_offset = x_1614.ray_offset;
    block_info.num_rays = x_1614.num_rays;
    block_info.lod = x_1614.lod;
  }
  workgroupBarrier();
  let x_1626 : u32 = block_info.id;
  let x_1627 : vec3<u32> = load_block_u1_(x_1626);
  block_dims_5 = x_1627;
  let x_1629 : u32 = gl_WorkGroupID.x;
  let x_1631 : u32 = x_1608.id_offset;
  let x_1634 : u32 = x_1608.total_active_blocks;
  if (((x_1629 + x_1631) >= x_1634)) {
    return;
  }
  let x_1640 : u32 = block_info.num_rays;
  if ((x_1640 == 0u)) {
    return;
  }
  let x_1647 : vec4<u32> = x_409.padded_dims;
  n_blocks_4 = (vec3<u32>(x_1647.x, x_1647.y, x_1647.z) / vec3<u32>(4u, 4u, 4u));
  let x_1653 : u32 = block_info.id;
  param_18 = x_1653;
  let x_1654 : vec3<u32> = block_id_to_pos_u1_(&(param_18));
  block_pos_3 = (x_1654 * vec3<u32>(4u, 4u, 4u));
  let x_1660 : vec4<f32> = x_409.volume_scale;
  volume_translation = (vec3<f32>(0.0f, 0.0f, 0.0f) - (vec3<f32>(x_1660.x, x_1660.y, x_1660.z) * 0.5f));
  let x_1670 : vec4<f32> = x_1668.eye_pos;
  let x_1672 : vec3<f32> = volume_translation;
  let x_1675 : vec4<f32> = x_409.volume_scale;
  transformed_eye = ((vec3<f32>(x_1670.x, x_1670.y, x_1670.z) - x_1672) / vec3<f32>(x_1675.x, x_1675.y, x_1675.z));
  let x_1679 : vec3<f32> = transformed_eye;
  let x_1681 : vec4<u32> = x_409.volume_dims;
  let x_1687 : vec3<u32> = block_pos_3;
  vol_eye_1 = (((x_1679 * vec3<f32>(vec3<u32>(x_1681.x, x_1681.y, x_1681.z))) - vec3<f32>(0.5f, 0.5f, 0.5f)) - vec3<f32>(x_1687));
  let x_1692 : u32 = block_info.num_rays;
  chunks = (x_1692 / 64u);
  let x_1695 : u32 = block_info.num_rays;
  if (((x_1695 % 64u) != 0u)) {
    let x_1700 : u32 = chunks;
    chunks = (x_1700 + bitcast<u32>(1i));
  }
  i_6 = 0u;
  loop {
    let x_1708 : u32 = i_6;
    let x_1709 : u32 = chunks;
    if ((x_1708 < x_1709)) {
    } else {
      break;
    }
    ...
    color.w = 1.0f;
    let x_1719 : u32 = i_6;
    let x_1722 : u32 = gl_LocalInvocationID.x;
    ray_id = ((x_1719 * 64u) + x_1722);
    let x_1724 : u32 = ray_id;
    let x_1726 : u32 = block_info.num_rays;
    if ((x_1724 < x_1726)) {
      let x_1736 : u32 = block_info.ray_offset;
      let x_1737 : u32 = ray_id;
      let x_1740 : u32 = x_1734.ray_ids[(x_1736 + x_1737)];
      ray_index = x_1740;
      let x_1742 : u32 = ray_index;
      param_19 = x_1742;
      let x_1743 : vec2<u32> = ray_id_to_pos_u1_(&(param_19));
      pixel_coords = bitcast<vec2<i32>>(x_1743);
      let x_1751 : u32 = block_info.ray_offset;
      let x_1752 : u32 = ray_id;
      let x_1755 : u32 = x_1749.spec_ids[(x_1751 + x_1752)];
      spec_index = x_1755;
      let x_1762 : u32 = ray_index;
      let x_1765 : vec3<f32> = x_1761.rays[x_1762].ray_dir;
      grid_ray_dir_1 = x_1765;
      hit_surface = false;
      hit_p_2 = vec3<f32>(0.0f, 0.0f, 0.0f);
      cell_range = vec2<f32>(0.0f, 0.0f);
      let x_1774 : vec3<f32> = vol_eye_1;
      param_20 = x_1774;
      let x_1776 : vec3<f32> = grid_ray_dir_1;
      param_21 = x_1776;
      let x_1777 : vec2<f32> = intersect_box_vf3_vf3_vf3_vf3_(&(param_20), &(param_21), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(4.0f, 4.0f, 4.0f));
      brick_range = x_1777;
      let x_1779 : f32 = brick_range.y;
      let x_1781 : f32 = brick_range.x;
      if ((x_1779 <= x_1781)) {
        continue;
      }
      let x_1788 : f32 = brick_range.x;
      let x_1791 : vec3<u32> = block_dims_5;
      let x_1796 : vec3<f32> = vol_eye_1;
      param_22 = x_1796;
      let x_1798 : vec3<f32> = grid_ray_dir_1;
      param_23 = x_1798;
      param_24 = (x_1788 - 0.00100000004749745131f);
      param_25 = (bitcast<vec3<i32>>(x_1791) - vec3<i32>(1i, 1i, 1i));
      let x_1801 : GridIterator = init_grid_iterator_vf3_vf3_f1_vi3_(&(param_22), &(param_23), &(param_24), &(param_25));
      grid_iter_1 = x_1801;
      v000_3 = vec3<i32>(0i, 0i, 0i);
      loop {
        var x_1841 : bool;
        var x_1842 : bool;
        let x_1810 : GridIterator = grid_iter_1;
        param_26 = x_1810;
        let x_1813 : bool = grid_iterator_get_cell_struct_GridIterator_vi3_vi3_vf3_vi3_vf3_f11_vf2_vi3_(&(param_26), &(param_27), &(param_28));
        let x_1814 : GridIterator = param_26;
        grid_iter_1 = x_1814;
        let x_1815 : vec2<f32> = param_27;
        cell_t_range_1 = x_1815;
        let x_1816 : vec3<i32> = param_28;
        v000_3 = x_1816;
        if (x_1813) {
        } else {
          break;
        }
        let x_1817 : vec3<i32> = v000_3;
        param_29 = bitcast<vec3<u32>>(x_1817);
        let x_1822 : vec3<u32> = block_dims_5;
        param_30 = x_1822;
        compute_vertex_values_vu3_vu3_f1_8__vf2_(&(param_29), &(param_30), &(param_31), &(param_32));
        let x_1826 : array<f32, 8u> = param_31;
        vertex_values_2 = x_1826;
        let x_1827 : vec2<f32> = param_32;
        cell_range = x_1827;
        let x_1830 : f32 = x_409.isovalue;
        let x_1832 : f32 = cell_range.x;
        let x_1833 : bool = (x_1830 < x_1832);
        x_1842 = x_1833;
        if (!(x_1833)) {
          let x_1838 : f32 = x_409.isovalue;
          let x_1840 : f32 = cell_range.y;
          x_1841 = (x_1838 > x_1840);
          x_1842 = x_1841;
        }
        skip_cell = x_1842;
        let x_1843 : bool = skip_cell;
        if (!(x_1843)) {
          let x_1847 : vec3<f32> = vol_eye_1;
          let x_1848 : vec3<f32> = grid_ray_dir_1;
          let x_1849 : vec3<i32> = v000_3;
          let x_1851 : array<f32, 8u> = vertex_values_2;
          let x_1853 : f32 = cell_t_range_1.x;
          let x_1855 : f32 = cell_t_range_1.y;
          let x_1858 : bool = marmitt_intersect_vf3_vf3_vf3_f1_8__f1_f1_f1_(x_1847, x_1848, vec3<f32>(x_1849), x_1851, x_1853, x_1855, &(param_33));
          let x_1859 : f32 = param_33;
          t_hit_1 = x_1859;
          hit_surface = x_1858;
          let x_1860 : bool = hit_surface;
          if (x_1860) {
            let x_1863 : vec3<f32> = vol_eye_1;
            let x_1864 : vec3<f32> = grid_ray_dir_1;
            let x_1865 : f32 = t_hit_1;
            hit_p_2 = (x_1863 + (x_1864 * x_1865));
            break;
          }
        }
        let x_1870 : GridIterator = grid_iter_1;
        param_34 = x_1870;
        grid_iterator_advance_struct_GridIterator_vi3_vi3_vf3_vi3_vf3_f11_(&(param_34));
        let x_1872 : GridIterator = param_34;
        grid_iter_1 = x_1872;
      }
      let x_1873 : bool = hit_surface;
      if (x_1873) {
        let x_1876 : u32 = ray_index;
        x_1761.rays[x_1876].t = 340282346638528859811704183484516925440.0f;
        let x_1880 : vec3<i32> = v000_3;
        let x_1881 : vec3<f32> = hit_p_2;
        let x_1882 : array<f32, 8u> = vertex_values_2;
        let x_1883 : vec3<f32> = compute_normal_vi3_vf3_f1_8__(x_1880, x_1881, x_1882);
        N_2 = x_1883;
        let x_1885 : vec3<f32> = grid_ray_dir_1;
        L_1 = normalize(-(x_1885));
        let x_1889 : vec3<f32> = grid_ray_dir_1;
        V_1 = normalize(-(x_1889));
        let x_1892 : vec3<f32> = N_2;
        let x_1893 : vec3<f32> = grid_ray_dir_1;
        if ((dot(x_1892, x_1893) > 0.0f)) {
          let x_1898 : vec3<f32> = N_2;
          N_2 = -(x_1898);
        }
        let x_1904 : vec3<f32> = N_2;
        param_35 = x_1904;
        let x_1906 : vec3<f32> = L_1;
        param_36 = x_1906;
        let x_1908 : vec3<f32> = V_1;
        param_37 = x_1908;
        param_38 = vec3<f32>(0.30000001192092895508f, 0.30000001192092895508f, 0.89999997615814208984f);
        let x_1910 : vec3<f32> = shading_vf3_vf3_vf3_vf3_(&(param_35), &(param_36), &(param_37), &(param_38));
        let x_1911 : vec4<f32> = color;
        color = vec4<f32>(x_1910.x, x_1910.y, x_1910.z, x_1911.w);
        let x_1917 : u32 = spec_index;
        let x_1919 : vec4<f32> = color;
        param_39 = vec3<f32>(x_1919.x, x_1919.y, x_1919.z);
        let x_1921 : i32 = pack_color_vf3_(&(param_39));
        let x_1923 : f32 = t_hit_1;
        x_1916.ray_rgbz[x_1917] = vec2<f32>(bitcast<f32>(x_1921), x_1923);
      }
    }

    continuing {
      let x_1927 : u32 = i_6;
      i_6 = (x_1927 + bitcast<u32>(1i));
    }
  }
  return;
}
...
@group(1) @binding(0) var<storage, read_write> x_199 : RayInformation;
...
fn main_1() {
  ...
  let x_200 : u32 = ray_index;
  let x_202 : f32 = x_199.rays[x_200].t;
  if ((x_202 == -340282346638528859811704183484516925440.0f)) {
    let x_207 : u32 = ray_index;
    x_199.rays[x_207].t = 340282346638528859811704183484516925440.0f;
  }
  return;
}
